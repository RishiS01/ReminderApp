...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_9__services_note_service__ = __webpack_require__("../../../../../src/app/services/note.service.ts");
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_14_ngx_chips__ = __webpack_require__("../../../../ngx-chips/dist/ngx-chips.bundle.js");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_14_ngx_chips___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_14_ngx_chips__);
...
var appRoutes = [
    { path: '', component: __WEBPACK_IMPORTED_MODULE_5__components_home_home_component__["a" /* HomeComponent */], canActivate: [__WEBPACK_IMPORTED_MODULE_10__guards_auth_guard__["a" /* AuthGuard */]] },
    ...
    AppModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_1__angular_core__["NgModule"])({
            ...
            imports: [
                ...
                __WEBPACK_IMPORTED_MODULE_11_angularfire2__["a" /* AngularFireModule */].initializeApp(firebaseCongfig),
                __WEBPACK_IMPORTED_MODULE_2__angular_router__["b" /* RouterModule */].forRoot(appRoutes),
                __WEBPACK_IMPORTED_MODULE_3__angular_forms__["FormsModule"],
                __WEBPACK_IMPORTED_MODULE_3__angular_forms__["ReactiveFormsModule"],
                __WEBPACK_IMPORTED_MODULE_14_ngx_chips__["TagInputModule"],
            ...
            providers: [
                ...
                __WEBPACK_IMPORTED_MODULE_9__services_note_service__["a" /* NoteService */],
...
var HomeComponent = (function () {
    function HomeComponent(noteService, authService, router) {
        var _this = this;
            ...
            _this.userNotes.forEach(function (val) {
                if (val.Title !== undefined) {
                    val.Title.map(function (tag) {
                        ...
                        if (__WEBPACK_IMPORTED_MODULE_4_lodash__["findIndex"](_this.notesWithTags, ['display', val.Title]) === -1) {
                            _this.notesWithTags.push(tag);
                        }
                        _this.notesWithTags = __WEBPACK_IMPORTED_MODULE_4_lodash__["uniqBy"](_this.notesWithTags, 'display');
                    });
                }
            });
        });
    ...
    HomeComponent.prototype.onItemAdded = function ($event, f) {
        console.log($event);
        this.onAddNote(f);
    };
    HomeComponent.prototype.onItemRemoved = function ($event, f) {
        console.log($event);
